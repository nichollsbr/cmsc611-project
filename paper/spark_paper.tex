...
Note that the jobs were not able to be run using only one or two executors due to cluster limitations.
Similarly, the cluster did not have enough cores to support

\subsubsection{Execution Time Comparison}

\begin{figure}
    \includegraphics[width=\linewidth]{../python_scripts/images/mapVsMapPartitionsAllExecutionTimeCluster.png}
    \caption{Comparison of Map job vs MapPartitions job vs Basic RDD job runs on the cluster}
