...
\author{\IEEEauthorblockN{1\textsuperscript{st} Brittany Nichols}
\IEEEauthorblockA{\textit{CSEE} \\
\textit{UMBC)}\\
Catonsville, United States \\
email}
\and
\IEEEauthorblockN{2\textsuperscript{nd} Mariama Adangwa}
\IEEEauthorblockA{\textit{CSEE} \\
\textit{UMBC}\\
Catonsville, United States \\
bama4@umbc.edu}
\and
\IEEEauthorblockN{3\textsuperscript{rd} Rachel}
\IEEEauthorblockA{\textit{CSEE} \\
\textit{UMBC}\\
Catonsville, United States \\
email address}
...
\bibitem{b5} L. Martin, ``Why spark's mapPartitions transformation is faster than map (calls your function once/partition, not once/element)'', 2016. [Online] Availiable: https://martin.atlassian.net/wiki/spaces/lestermartin/blog/2016/05/19/67043332/why+spark+
