...
We need to make this comparison to determine how to work with RDDs for future usage.
Should find the blog post that talked about map vs mapPartitions.
Mention the benefits of each (maybe include a reference)
